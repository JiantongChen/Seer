...
### 脚本名称
RANK_SCRIPT="/ailab/user/chenjiantong/code/Seer/scripts/cjt/fractal20220817_data_lerobot/slurm_finetune.sh"
...
do
 ...
 srun -N 1 --gres=gpu:$GPUS -w $node_host -n 1 -c 96 bash ${RANK_SCRIPT} ${NODES} ${GPUS} $node_rank ${MASTER_ADDR} ${JOB_ID} &
done
wait