...
resume_from_checkpoint="checkpoints/simulation/calvin_abc_d/seer/finetine_bs=640_lr1e-4_atten_goal_state4_atten_only_obs_sv10_abc_reset_act_obs_ep5_abc/15.pth"
