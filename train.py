...
from utils.data_utils import get_calvin_dataset, get_calvin_val_dataset, get_droid_dataset, get_libero_pretrain_dataset, get_libero_finetune_dataset, get_real_finetune_dataset, get_oxe_dataset, get_bridge_dataset, get_fractal_dataset
...
def main(args):
    ...
    elif args.finetune_type == "fractal":
        calvin_dataset = get_fractal_dataset(args, model.image_processor, clip, epoch=0)
